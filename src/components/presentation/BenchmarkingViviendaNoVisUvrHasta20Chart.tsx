...
export default function BenchmarkingViviendaNoVisUvrHasta20Chart() {
    ...
    const data = globalData.benchmarkingViviendaNoVisUvrHasta20;
    ...
    const handleUpdate = (index: number, field: string, value: string) => {
        ...
        updateSection('benchmarkingViviendaNoVisUvrHasta20', newData);
    };
            ...
            <div className="flex justify-between items-start mb-4">
                <div>
                    <h3 className="text-2xl font-bold text-white">
                        Benchmarking - Compra de vivienda NO VIS UVR
                    </h3>
                    <p className="text-yellow-500 font-semibold text-lg">Hasta 20 años</p>
                </div>
                <div className="flex gap-4 items-center">
                    <div className="bg-yellow-500/10 px-4 py-2 rounded-xl border border-yellow-500/20 text-center">
                        <p className="text-xs text-slate-400 uppercase">Sector</p>
                        <p className="text-xl font-bold text-yellow-400">13,31% <span className="text-sm font-normal text-slate-400">ea</span></p>
                    </div>
                    <button
            ...
            <div className="flex-1 w-full min-h-0 flex gap-6">
                <div className="w-48 flex flex-col justify-center gap-6 border-r border-white/10 pr-6">
                    ...
                    <div>
                        ...
                        <p className="text-2xl font-bold text-emerald-400">13,31%</p>
                    </div>
                </div>
