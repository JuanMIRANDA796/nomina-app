...
export default function BenchmarkingConsumo3To6Chart() {
    ...
    const data = globalData.benchmarkingConsumo3To6;
    ...
    const handleUpdate = (index: number, field: string, value: string) => {
        ...
        updateSection('benchmarkingConsumo3To6', newData);
    };
            ...
            <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex gap-4 items-center">
                    <div className="bg-white/10 px-4 py-2 rounded-xl border border-white/10 text-center">
                        ...
                        <p className="text-xl font-bold">21,07% <span className="text-sm font-normal text-slate-400">ea</span></p>
                    </div>
                    <button
