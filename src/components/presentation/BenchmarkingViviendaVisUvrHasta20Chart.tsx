    ...
    const data = selectedMonth === 'diciembre'
        ...
        : selectedMonth === 'enero'
            ...
            : selectedMonth === 'febrero'
                ? globalData.benchmarkingViviendaVisUvrHasta20Febrero
                : globalData.benchmarkingViviendaVisUvrHasta20Marzo;

    const sectionKey = selectedMonth === 'diciembre'
        ? 'benchmarkingViviendaVisUvrHasta20'
        : selectedMonth === 'enero'
            ? 'benchmarkingViviendaVisUvrHasta20Enero'
            : selectedMonth === 'febrero'
                ? 'benchmarkingViviendaVisUvrHasta20Febrero'
