...
export default function BenchmarkingViviendaVisUvrHasta20Chart() {
    ...
    const data = selectedMonth === 'diciembre'
        ? globalData.benchmarkingViviendaVisUvrHasta20
        : globalData.benchmarkingViviendaVisUvrHasta20Enero;

    const sectionKey = selectedMonth === 'diciembre' ? 'benchmarkingViviendaVisUvrHasta20' : 'benchmarkingViviendaVisUvrHasta20Enero';
