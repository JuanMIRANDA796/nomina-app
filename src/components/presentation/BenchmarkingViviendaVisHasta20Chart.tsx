...
export default function BenchmarkingViviendaVisHasta20Chart() {
    ...
    const data = globalData.benchmarkingViviendaVisHasta20;
    ...
    const handleUpdate = (index: number, field: string, value: string) => {
        ...
        updateSection('benchmarkingViviendaVisHasta20', newData);
    };
            ...
            <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex gap-4 items-center">
                    <div className="bg-emerald-500/10 px-4 py-2 rounded-xl border border-emerald-500/20 text-center">
                        ...
                        <p className="text-xl font-bold text-emerald-400">10,93% <span className="text-sm font-normal text-slate-400">ea</span></p>
                        <p className="text-xs text-emerald-500/80 font-medium">$873</p>
                    </div>
                    <button
