...
export default function BenchmarkingConsumo1To3Chart() {
    ...
    const data = globalData.benchmarkingConsumo1To3;
    ...
    const handleUpdate = (index: number, field: string, value: string) => {
        ...
        updateSection('benchmarkingConsumo1To3', newData);
    };
            ...
            <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex gap-4 items-center">
                    <div className="bg-white/10 px-4 py-2 rounded-xl border border-white/10 text-center">
                        ...
                        <p className="text-xl font-bold">22,49% <span className="text-sm font-normal text-slate-400">ea</span></p>
                    </div>
                    <button
