...
export default function BenchmarkingConsumo6To12Chart() {
    ...
    const data = globalData.benchmarkingConsumo6To12;
    ...
    const handleUpdate = (index: number, field: string, value: string) => {
        ...
        updateSection('benchmarkingConsumo6To12', newData);
    };
            ...
            <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex gap-4 items-center">
                    <div className="bg-white/10 px-4 py-2 rounded-xl border border-white/10 text-center">
                        ...
                        <p className="text-xl font-bold">20,96% <span className="text-sm font-normal text-slate-400">ea</span></p>
                    </div>
                    <button
            ...
            <div className="flex-1 w-full min-h-0 flex gap-6">
                <div className="w-48 flex flex-col justify-center gap-6 border-r border-white/10 pr-6">
                    ...
                    <div>
                        ...
                        <p className="text-2xl font-bold text-orange-400">$506,65 mil M</p>
                    </div>
                    <div>
                        <p className="text-xs text-slate-400 uppercase font-bold mb-1">Desembolsos</p>
                        <p className="text-2xl font-bold text-slate-200">42.609</p>
                    </div>
                    <div>
                        <p className="text-xs text-slate-400 uppercase font-bold mb-1">Tasa Prom. EA</p>
                        <p className="text-2xl font-bold text-emerald-400">22,31%</p>
                    </div>
                </div>
