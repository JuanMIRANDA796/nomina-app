...
export default function BenchmarkingViviendaVisUvrSup20Chart() {
    ...
    const data = selectedMonth === 'diciembre'
        ...
        : selectedMonth === 'enero'
            ...
            : globalData.benchmarkingViviendaVisUvrSup20Febrero;

    const sectionKey = selectedMonth === 'diciembre' 
        ? 'benchmarkingViviendaVisUvrSup20' 
        : selectedMonth === 'enero' 
            ? 'benchmarkingViviendaVisUvrSup20Enero' 
            : 'benchmarkingViviendaVisUvrSup20Febrero';
            ...
            <div className="flex justify-between items-start mb-4">
                <div>
                    <h3 className="text-2xl font-bold text-white">
                        Benchmarking - Compra de vivienda VIS UVR <span className="text-lime-400">{selectedMonth === 'diciembre' ? 'Diciembre' : selectedMonth === 'enero' ? 'Enero' : 'Febrero'}</span>
                    </h3>
                ...
                <div className="flex gap-3 items-center">
                    <div className="flex bg-slate-800 rounded-lg border border-white/10 overflow-hidden">
                        ...
                        <button onClick={() => setSelectedMonth('febrero')} className={`px-3 py-1.5 text-xs font-bold transition-all ${selectedMonth === 'febrero' ? 'bg-lime-600 text-white' : 'text-slate-400 hover:text-white'}`}>Feb</button>
                    </div>
                    <RateBox 
