...
export default function BenchmarkingViviendaVisUvrSup20Chart() {
    ...
    const data = globalData.benchmarkingViviendaVisUvrSup20;
    ...
    const handleUpdate = (index: number, field: string, value: string) => {
        ...
        updateSection('benchmarkingViviendaVisUvrSup20', newData);
    };
        ...
        <div className="w-full h-[580px] p-6 bg-white/5 rounded-3xl border border-white/10 backdrop-blur-sm shadow-2xl flex flex-col relative">
            ...
            <div className="flex justify-between items-start mb-4">
                <div>
                    ...
                    <p className="text-lime-600 font-semibold text-lg">Superior a 20 años</p>
                </div>
            ...
            <div className="flex-1 w-full min-h-0 flex gap-6">
                <div className="w-48 flex flex-col justify-center gap-6 border-r border-white/10 pr-6">
                    ...
                    <div>
                        ...
                        <p className="text-2xl font-bold text-orange-400">$326,54 mil M</p>
                    </div>
                    <div>
                        <p className="text-xs text-slate-400 uppercase font-bold mb-1">Desembolsos</p>
                        <p className="text-2xl font-bold text-slate-200">2.911</p>
                    </div>
                    <div>
                        <p className="text-xs text-slate-400 uppercase font-bold mb-1">Tasa Prom. EA</p>
                        <p className="text-2xl font-bold text-emerald-400">11,60%</p>
                    </div>
                </div>
