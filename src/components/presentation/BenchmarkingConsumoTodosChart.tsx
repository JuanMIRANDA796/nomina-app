    ...
    const data = selectedMonth === 'diciembre'
        ...
        : selectedMonth === 'enero'
            ...
            : selectedMonth === 'febrero'
                ...
                : globalData.benchmarkingConsumoTodosMarzo;
    ...
    return (
        <div className="w-full h-[580px] p-6 bg-white/5 rounded-3xl border border-white/10 backdrop-blur-sm shadow-2xl flex flex-col relative">
            ...
            <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex gap-3 items-center">
                    <div className="flex bg-slate-800 rounded-lg border border-white/10 overflow-hidden">
                        ...
                        <button onClick={() => setSelectedMonth('marzo')} className={`px-3 py-1.5 text-xs font-bold transition-all ${selectedMonth === 'marzo' ? 'bg-slate-600 text-white' : 'text-slate-400 hover:text-white'}`}>Mar</button>
                    </div>
                    <RateBox 
            ...
            <div className="flex-1 w-full min-h-0 flex gap-6">
                <EditableStatsSidebar totals={totals} onUpdate={(field, value) => handleUpdate(0, field, value)} amountUnit="bill" />
