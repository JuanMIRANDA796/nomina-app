...
export default function BenchmarkingViviendaNoVisHasta20Chart() {
    ...
    const data = selectedMonth === 'diciembre'
        ? globalData.benchmarkingViviendaNoVisHasta20
        : selectedMonth === 'enero'
            ? globalData.benchmarkingViviendaNoVisHasta20Enero
    ...
    const sectionKey = selectedMonth === 'diciembre' 
        ...
        : selectedMonth === 'enero' 
            ? 'benchmarkingViviendaNoVisHasta20Enero' 
            ...
            <div className="flex justify-between items-start mb-4">
                <div>
                    <h3 className="text-2xl font-bold text-white">
                        Benchmarking - Compra de vivienda NO VIS pesos <span className="text-cyan-400">{selectedMonth === 'diciembre' ? 'Diciembre' : selectedMonth === 'enero' ? 'Enero' : 'Febrero'}</span>
                    </h3>
            ...
            <div className="flex-1 w-full min-h-0 flex gap-6">
                <div className="w-48 flex flex-col justify-center gap-6 border-r border-white/10 pr-6">
                    ...
                    <div>
                        ...
                        <p className="text-2xl font-bold text-orange-400">${totals?.amount != null ? (totals.amount / 1000).toFixed(2) : '-'} bill.</p>
                    </div>
                    <div>
