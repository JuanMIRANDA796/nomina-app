...
export default function BenchmarkingViviendaNoVisHasta20Chart() {
    ...
    const prefix = 'benchmarkingViviendaNoVisHasta20';
                        ...
                        <div className="flex bg-slate-800 rounded-lg border border-white/10 overflow-hidden flex-wrap">
                            {existingMonths.map(m => (
                                <button
                                    ...
                                    className={`px-3 py-1.5 text-xs font-bold transition-all ${selectedMonth === m ? 'bg-cyan-600 text-white' : 'text-slate-400 hover:text-white'}`}
                                >
                                    {MONTH_LABELS[m] || m}
                                </button>
                            ))}
                            ...
                            <div className="flex items-center gap-3">
                                <div className="relative">
                                    <button
                                        ...
                                        className="px-3 py-1.5 bg-cyan-600/20 hover:bg-cyan-600/40 text-cyan-400 rounded-lg text-xs font-bold transition-all border border-cyan-500/20 flex items-center gap-1 shadow-lg"
                                    >
                                        + Agregar Mes
                                    </button>
                                    {showAddMenu && (
